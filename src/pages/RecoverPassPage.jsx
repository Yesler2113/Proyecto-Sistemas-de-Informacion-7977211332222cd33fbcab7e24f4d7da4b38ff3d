        ...
        <div className="w-full">
          ...
          <form className="flex justify-center" onSubmit={handleSubmit}>
            <div>
              ...
              <button type="submit" className="w-1/4 bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-700 transition duration-300 ml-16 m-5">
                Enviar
              </button>
              <button type="submit" onClick={handleSubmitRegresar} className="w-1/4 bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-700 transition duration-300 ml-6">
                Regresar
              </button>
              </div>
            </div>
